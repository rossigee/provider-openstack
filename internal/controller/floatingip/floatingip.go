...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(networkingv1beta1.FloatingIPKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(networkingv1beta1.SchemeGroupVersion.WithKind(networkingv1beta1.FloatingIPKind)),
		opts...)
