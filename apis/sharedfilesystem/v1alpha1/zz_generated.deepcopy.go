...
func (in *SharenetworkV2InitParameters) DeepCopyInto(out *SharenetworkV2InitParameters) {
	*out = *in
	...
	if in.NeutronNetIDRef != nil {
		in, out := &in.NeutronNetIDRef, &out.NeutronNetIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.NeutronNetIDSelector != nil {
		in, out := &in.NeutronNetIDSelector, &out.NeutronNetIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.NeutronSubnetIDRef != nil {
		in, out := &in.NeutronSubnetIDRef, &out.NeutronSubnetIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.NeutronSubnetIDSelector != nil {
		in, out := &in.NeutronSubnetIDSelector, &out.NeutronSubnetIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.Region != nil {
	...
	if in.SecurityServiceIdsRefs != nil {
		in, out := &in.SecurityServiceIdsRefs, &out.SecurityServiceIdsRefs
		*out = make([]v1.Reference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.SecurityServiceIdsSelector != nil {
		in, out := &in.SecurityServiceIdsSelector, &out.SecurityServiceIdsSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
}
